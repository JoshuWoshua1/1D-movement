class Path extends Phaser.Scene {
    ...
    update() {
        ...
        if (Phaser.Input.Keyboard.JustDown(this.ESCKey)) {
            console.log("Clear path", this.runMode);
            // TODO: 
            ...
            if (!this.runMode) {
                ...
                console.log("can't clear while running")
            }
        }
        ...
        if (Phaser.Input.Keyboard.JustDown(this.oKey)) {
            ...
            // ]
            let coordList = [];
            for (let coords of this.curve.points) {
                coordList.push(coords.x, coords.y);
            }
            console.log("[");
            for (let i = 0; i < coordList.length; i += 2) {
                console.log(`${coordList[i]}, ${coordList[i+1]},`)
            }
            console.log("]");
        }   
        ...
        if (Phaser.Input.Keyboard.JustDown(this.rKey)) {
            ...
            const ship = my.sprite.enemyShip;
